        ...
        <div>
          ...
          <div style="margin-top:20px;padding:14px 18px;border-radius:10px;background:rgba(255,237,0,0.06);border:1px solid rgba(255,237,0,0.2);display:flex;align-items:center;gap:14px">
            ...
            <p style="font-size:0.9rem;color:var(--color-text-on-dark);line-height:1.5">
              ...
              <span style="font-size:0.7rem;color:var(--color-text-on-dark-subdued);opacity:0.6">Inhalt veraltet oder ungenau? <a href="https://github.com/HUK-COBURG/agentic-ai-workshops" target="_blank" rel="noopener" style="color:inherit;text-decoration:underline">Pull Request willkommen.</a></span>
            </p>
          </div>
        </div>
