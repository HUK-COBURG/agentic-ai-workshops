...
[Apache 2.0](LICENSE) · Repo: [HUK-COBURG/agentic-ai-workshops](https://github.com/HUK-COBURG/agentic-ai-workshops)

---

Der ursprüngliche Standalone-Workshop liegt unverändert unter `tmp/agentic-ai-workshop/` (nicht versioniert, siehe `.gitignore`) und kann nach erfolgreicher Prüfung entfernt werden.
